...
import com.salor.ventgo.databinding.ActivityScannerStockMasukBinding
...
class ScannerActivity : BaseActivity(), DecoratedBarcodeView.TorchListener {
    ...
    lateinit var binding: ActivityScannerStockMasukBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityScannerStockMasukBinding.inflate(layoutInflater)
