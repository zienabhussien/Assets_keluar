...
import com.salor.ventgo.databinding.ItemDialogStockOpnameUpdateQuantityBinding
...
class ListScannedProductStockOpnameAdapter(private val context: Activity, private val item_homes: List<StockOpnameListStock>,
                                           var stockOpnameActivity: StockOpnameListScannedProductActivity) : RecyclerView.Adapter<ListScannedProductStockOpnameAdapter.MyViewHolder>() {
...
//            context.startActivity(intent)
    ...
    fun dialogUpdateStock(idStock: String) {
        ...
        try {
            ...
            val binding = ItemDialogStockOpnameUpdateQuantityBinding.inflate(LayoutInflater.from(context))
            pDialog.setContentView(binding.root)
            pDialog.setCancelable(false)

            val etQty = binding.etQty
