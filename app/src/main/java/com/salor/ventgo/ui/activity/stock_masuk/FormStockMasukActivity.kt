...
import com.salor.ventgo.databinding.ActivityFormStockMasukBinding
...
class FormStockMasukActivity : BaseActivity() {
    ...
    lateinit var binding: ActivityFormStockMasukBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityFormStockMasukBinding.inflate(layoutInflater)
        ...
        binding.rBack.setOnClickListener { onBackPressed() }

        val str_json = intent.getStringExtra(Cons.JSON)
        scanStockMasuk = Gson().fromJson(str_json, ScanStockMasuk::class.java)

        binding.tvTitle.text = scanStockMasuk.name
        binding.tvSku.text = scanStockMasuk.sku

        binding.ivBarcode.setBarcodeText(scanStockMasuk.sku)
        ...
        binding.spGudang.adapter = spinnerAdapterGudang
        ...
        try {
            ...
            binding.spTipeQuantity.adapter = spinnerAdapterQuantity
       ...
       binding.btnSubmit.setOnClickListener {
            ...
            str_pno = binding.etPno.text.toString()
