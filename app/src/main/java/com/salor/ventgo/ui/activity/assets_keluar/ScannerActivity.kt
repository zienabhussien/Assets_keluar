...
class ScannerActivity : BaseActivity(), DecoratedBarcodeView.TorchListener {
    ...
    lateinit var binding: ActivityScannerAssetsKeluarBinding


    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityScannerAssetsKeluarBinding.inflate(layoutInflater)
...
//            capture!!.onDestroy()
        ...
        binding.btnList.setOnClickListener(View.OnClickListener {

            val intent = Intent(this@ScannerActivity,AssetsKeluarListActivity::class.java)
...
//            closeAndFinish()
        ...
        private fun userScan(code: String) {
            ...
            val call = service.scanAssetBarangKeluar(code)
            See.logE("code", "" + code)
            ...
            call.enqueue(object : Callback<ResponseBody> {
                    ...
                    if (response.isSuccessful) {
                        try {
                            ...
                            if (api_status == Cons.INT_STATUS) {
                                ...
                                val datum: ScanAssetKeluar
                                datum = gson.fromJson(jsonObjScan.toString(), ScanAssetKeluar::class.java!!)
                                ...
                                val intent = Intent(activity, FormAssetsKeluarActivity::class.java)
                        ...
                        barcodeView.decodeSingle(callback)
                        pLoading.dismissDialog()
                        Toast.makeText(activity, activity.resources.getString(R.string.label_something_wrong), Toast.LENGTH_SHORT).show()
                    }
                }
                ...
                override fun onFailure(call: Call<ResponseBody>, t: Throwable) {
                    ...
                    barcodeView.decodeSingle(callback)
                    pLoading.dismissDialog()
                    Toast.makeText(activity, activity.resources.getString(R.string.label_koneksi_error), Toast.LENGTH_SHORT).show()
                }
            })
...
//        fun dialogSuccessScan(data: Scan) {
//
//            val dialog = Dialog(activity, R.style.DialogLight)
...
//            val tvDepartment: TextView = dialog.findViewById(R.id.tvDepartment)
//            val tvJamCheckin: TextView = dialog.findViewById(R.id.tvJamCheckin)
//            val ivImage: CircleImageView = dialog.findViewById(R.id.ivImage)
//
//            val pbLoading: ProgressBar = dialog.findViewById(R.id.pbLoading)
//
//            tvName.text = data.name
//            tvDepartment.text = data.departement
//            tvJamCheckin.text = data.checkInDate
//
//            loadImagePicasso(data.image!!, ivImage, pbLoading)
//
...
//        fun dialogAfterCheckIn(message : String) {
//
//            val dialog = Dialog(activity, R.style.DialogLight)
//            dialog.window!!.attributes.windowAnimations = R.style.PauseDialogAnimation
//            dialog.requestWindowFeature(Window.FEATURE_NO_TITLE)
//            dialog.setContentView(R.layout.dialog_scan_after_checkin)
//            dialog.setCancelable(false)
//
//            val btnOke: Button = dialog.findViewById(R.id.btnOke)
...
//        }
    ...
    private fun userScan(code: String) {
        pLoading.showLoading(this.resources.getString(R.string.label_loading_title_dialog), false)
        val service = ApiClient.getClient()
        val gson = Gson()
        ...
        call.enqueue(object : Callback<ResponseBody> {
                ...
                if (response.isSuccessful) {
                    try {
                        ...
                        if (api_status == Cons.INT_STATUS) {
                            ...
                            val intent = Intent(this@ScannerActivity, FormAssetsKeluarActivity::class.java)
                            intent.putExtra(Cons.JSON, Gson().toJson(datum))
                            startActivity(intent)
                            finish()
                            setOveridePendingTransisi(this@ScannerActivity)
                    ...
                    barcodeScannerView!!.resume()
                    pLoading.dismissDialog()
                    Toast.makeText(this@ScannerActivity, resources.getString(R.string.label_something_wrong), Toast.LENGTH_SHORT).show()
                }
            }
            ...
            override fun onFailure(call: Call<ResponseBody>, t: Throwable) {
                barcodeScannerView!!.resume()
                pLoading.dismissDialog()
                Toast.makeText(this@ScannerActivity, resources.getString(R.string.label_koneksi_error), Toast.LENGTH_SHORT).show()
            }
        })
    ...
    fun dialogScanSuccess() {
        ...
        try {
            ...
            binding.btnListProduk.setOnClickListener(View.OnClickListener {
            ...
            binding.btnScanResume.setOnClickListener(View.OnClickListener {
