package com.salor.ventgo.ui.activity.barang_assets
...
class ListBarangActivity : BaseActivity() {
    ...
    var offset : Int = 0
    var limit : Int = 20
    var listData : ArrayList<BarangAssets> = ArrayList()
    lateinit var listBarangAdapter: ListBarangAdapter
    lateinit var binding: ActivityListBarangBinding
...
//                )
    ...
    private fun getDataListBarang(pbLoading : LinearLayout,isSearch : Boolean) {
        ...
        val call = service.assetBarangList(limit,offset,str_keyword_search)
                ...
                if (response.isSuccessful) {
                    try {
                        ...
                        if (api_status == Cons.INT_STATUS) {
                            ...
                            val listBarang = Gson().fromJson(jsonDataArray.toString(), Array<BarangAssets>::class.java).toList()
