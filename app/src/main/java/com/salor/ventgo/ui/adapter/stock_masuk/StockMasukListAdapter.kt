...
class StockMasukListAdapter(private val context: Activity, private val item_homes: List<StockListBarangMasuk>,
                            var listActivity : StockMasukListActivity) : RecyclerView.Adapter<StockMasukListAdapter.MyViewHolder>() {
