...
class FormAssetsKeluarActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.tvGudang.text = scanBarang.gudang
        binding.tvCode.text = str_code
        binding.tvName.text = scanBarang.name
        binding.tvSku.text = scanBarang.sku

        binding.ivBarcode.setBarcodeText(scanBarang.code)
