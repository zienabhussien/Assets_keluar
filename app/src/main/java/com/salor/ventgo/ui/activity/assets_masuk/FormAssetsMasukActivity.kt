...
class FormAssetsMasukActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityFormAssetsMasukBinding.inflate(layoutInflater)
...
//            }
        ...
        binding.tvName.text = dataScan.name
        binding.tvSku.text = dataScan.sku
        binding.tvCode.text = str_code

        binding.ivBarcode.setBarcodeText(dataScan.code)
    ...
    fun dialogTerkirim() {
        ...
        try {
            ...
            binding.tvContentDialog.text = "Data produk code " + str_code + " berhasil ditambahkan ke sistem "
