...
class ListGudangStockAdapter(private val context: Activity, private val item_homes: List<WarehouseStock>) :
                                                        RecyclerView.Adapter<ListGudangStockAdapter.MyViewHolder>() {


    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        // infalte the item Layout
        val v = LayoutInflater.from(parent.context).inflate(R.layout.item_list_barang_gudang_adapter,
            parent, false)
