...
import com.salor.ventgo.databinding.ActivityScannerAssetsMasukBinding
...
class ScannerActivity : BaseActivity(), DecoratedBarcodeView.TorchListener {
    ...
    lateinit var binding: ActivityScannerAssetsMasukBinding


    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityScannerAssetsMasukBinding.inflate(layoutInflater)
...
//            capture!!.onDestroy()
        ...
        binding.btnList.setOnClickListener(View.OnClickListener {
            ...
            val intent = Intent(this@ScannerActivity, AssetsMasukListActivity::class.java)
...
//            closeAndFinish()
        ...
        private fun userScan(code: String) {
            ...
            val call = service.scanAssetBarangMasuk(code)
            See.logE("code", "" + code)
                    ...
                    if (response.isSuccessful) {
                        try {
                            ...
                            if (api_status == Cons.INT_STATUS) {
                                ...
                                val datum: ScanAssetMasuk
                                datum = gson.fromJson(jsonObjScan.toString(), ScanAssetMasuk::class.java!!)
                                ...
                                val intent = Intent(activity, FormAssetsMasukActivity::class.java)
                ...
                if (response.isSuccessful) {
                    try {
                        ...
                        if (api_status == Cons.INT_STATUS) {
                            ...
                            val intent = Intent(this@ScannerActivity, FormAssetsMasukActivity::class.java)
                            intent.putExtra(Cons.JSON, Gson().toJson(datum))
                            startActivity(intent)
                            finish()
