...
import com.salor.ventgo.databinding.ActivityScannerStockKeluarBinding
...
class ScannerActivity : BaseActivity(), DecoratedBarcodeView.TorchListener {
    ...
    lateinit var binding : ActivityScannerStockKeluarBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityScannerStockKeluarBinding.inflate(layoutInflater)
...
//            capture!!.onDestroy()
       ...
       binding.btnList.setOnClickListener(View.OnClickListener {
            ...
            val intent = Intent(this@ScannerActivity, StockKeluarListActivity::class.java)
...
//            closeAndFinish()
        ...
        private fun userScan(code: String) {
            ...
            val call = service.stockBarangKeluarScan(code)
            See.logE("code", "" + code)
                    ...
                    if (response.isSuccessful) {
                        try {
                            ...
                            if (api_status == Cons.INT_STATUS) {
                                ...
                                val datum: ScanStockKeluar
                                datum = gson.fromJson(jsonObjScan.toString(), ScanStockKeluar::class.java!!)
                                ...
                                val intent = Intent(activity, FormStockKeluarActivity::class.java)
            ...
            binding.btnCheck.setOnClickListener(View.OnClickListener {
                ...
                if (str_code == ""){
                   ...
                   binding.etCode.error = resources.getString(R.string.label_form_wajib_diisi)
                    ...
                    userScan(str_code)
//                    val intent = Intent(this@ScannerActivity,FormStockKeluarActivity::class.java)
//                    startActivity(intent)
